...
const DesktopView = () => {
  ...
  return (
    <div className="">
      {/* Header */}
      <h1 className="font-bold text-4xl mt-4 lg:text-5xl lg:mt-10 sm:text-3xl sm:mt-6 ml-4 sm:text-center">
      ...
      {/* Filter Section */}
      <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 mb-5 mt-4 p-4 sm:space-x-2 justify-center lg:w-[80%] lg:ml-28 lg:mt-10 lg:mb-16 lg:rounded-full lg:shadow-lg lg:bg-white lg:p-4">
        <div className="flex flex-col sm:flex-row w-full">
          ...
          <div className="relative flex-grow" ref={searchInputRef}>
            <input
              ...
              name="searchTerm"
              placeholder={
                status.error ? "" : "Search by job, company or skills"
              }
        ...
        <div className="flex flex-col sm:flex-row">
          ...
          {!isMobile && pagination.selectedJobId && (
            <div className="w-full sm:w-2/3 pl-4">
              <JobDetails
                job={filteredJobs.find(
                  (job) => job.id === pagination.selectedJobId
                )}
                selectedJobId={pagination.selectedJobId}
                formatDescription={formatDescription}
                formatDate={formatDate}
