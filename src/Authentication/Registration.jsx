        ...
        <form onSubmit={handleSubmit}>
          <div className="relative mb-4">
            ...
            <input
              ...
              className={`w-full p-2 border rounded pl-3 ${errors.name ? 'border-red-500' : 'border-gray-300'}`}
          ...
          <div className="relative mb-4">
            ...
            <input
              ...
              onChange={handleChange}
              className={`w-full p-2 border rounded pl-3 ${errors.email ? 'border-red-500' : 'border-gray-300'}`}
          ...
          <div className="relative mb-4">
            ...
            <input
              ...
              onChange={handleChange}
              className={`w-full p-2 border rounded pl-3 ${errors.password ? 'border-red-500' : 'border-gray-300'}`}
          ...
          <div className="relative mb-4">
            ...
            <input
              ...
              onChange={handleChange}
              className={`w-full p-2 border rounded pl-3 ${errors.confirmPassword ? 'border-red-500' : 'border-gray-300'}`}
          ...
          <div className="relative mb-4">
            ...
            <input
              ...
              onChange={handleChange}
              className={`w-full p-2 border rounded pl-3 ${errors.mobile ? 'border-red-500' : 'border-gray-300'}`}
