...
const Registration = () => {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-transparent mt-5">
      <div className="bg-transparent p-8 rounded w-full max-w-md -mt-36 sm:-mt-8">

        {/* Logo Section */}
        <div className="text-2xl font-bold text-gray-900 ml-6 mb-6 lg:text-center">
        ...
        <form onSubmit={handleSubmit}>
          <div className="relative mb-4">
            ...
            <input
              ...
              className={`w-full p-2 border shadow-sm rounded-lg focus:outline-blue-500 pl-3 ${errors.name ? 'border-red-500' : 'border-gray-300'}`}
          ...
          <div className="relative mb-4">
            ...
            <input
              ...
              onChange={handleChange}
              className={`w-full p-2 border shadow-sm rounded-lg focus:outline-blue-500 pl-3 ${errors.email ? 'border-red-500' : 'border-gray-300'}`}
          ...
          <div className="relative mb-4">
            ...
            <input
              ...
              onChange={handleChange}
              className={`w-full p-2 border shadow-sm rounded-lg focus:outline-blue-500 pl-3 ${errors.password ? 'border-red-500' : 'border-gray-300'}`}
          ...
          <div className="relative mb-4">
            ...
            <input
              ...
              onChange={handleChange}
              className={`w-full p-2 border shadow-sm rounded-lg focus:outline-blue-500 pl-3 ${errors.confirmPassword ? 'border-red-500' : 'border-gray-300'}`}
          ...
          <div className="relative mb-4">
            ...
            <input
              ...
              onChange={handleChange}
              className={`w-full p-2 border shadow-sm rounded-lg focus:outline-blue-500 pl-3 ${errors.mobile ? 'border-red-500' : 'border-gray-300'}`}
          ...
          <div className="relative mb-4">
            <input
              ...
              name="resume"
              onChange={handleChange}
              className={`w-full p-2 border focus:outline-blue-500 shadow-sm rounded-lg ${errors.resume ? 'border-red-500' : 'border-gray-300'}`}
            />
